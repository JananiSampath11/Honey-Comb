...
function French(){
    const french=[{
        ...
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/French Crepes.jpeg",
    },{
        name:"Classic Coq Au Vin",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Classic Coq Au Vin.jpeg",
    },{
        name:"Financiers",
        description:"Available from 8am to 10pm",
        price:"15",
        ...
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Triple-Threat Onion Galette.jpeg",
    },{
        name:"French Beans with Shallots",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/French Green Beans with Shallots.jpeg",
    },{
        name:"Croque-Monsieur",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Croque-Monsieur.jpeg",
    },{
        name:"French Cruller Donuts",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/French Cruller Donuts.jpeg",
    },{
        name:"Easy Quiche",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Easy Quiche.jpeg",
    },{
        name:"French Toast Casserole",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/French Toast Casserole.jpeg",
    },{
        name:"Mushroom Galette",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Mushroom Galette.jpeg",
    },{
        name:"Gougères (French Cheese Puffs)",
        description:"Available from 8am to 10pm",
        price:"15",
        image:"images/Gougères.jpeg",
    }]
    
    const [num,setNum]=useState(french.map(item=>0));
        const [disable,setDisable]=useState(french.map(item=>false));
...
<div className="w-full flex items-center justify-center h-[80vh]">
        ...
        <div className=" w-3/4 h-full bg-white " >
            ...
            {french.map(({name,description,price,image},i)=>(
